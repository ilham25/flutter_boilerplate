...
class ChatDetailRoute extends _i9.PageRouteInfo<ChatDetailRouteArgs> {
  ChatDetailRoute({
    _i10.Key? key,
...
class ChatListRoute extends _i9.PageRouteInfo<void> {
  const ChatListRoute({List<_i9.PageRouteInfo>? children})
...
class FeedbackRoute extends _i9.PageRouteInfo<void> {
  const FeedbackRoute({List<_i9.PageRouteInfo>? children})
